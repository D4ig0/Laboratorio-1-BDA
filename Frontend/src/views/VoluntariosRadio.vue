<template>
    <div class="center">
        ...
        <div class="input-container">
            <InputField @inputData="setRadio" fieldName="Ingrese el radio para analizar los voluntarios cercanos"
                inputType="text" />
...
export default defineComponent({
    ...
    methods: {
        getVoluntariosRadio() {
            ...
            axios
                .get("/api/voluntarios/emergencia/" + this.$route.params.id + "/" + this.radio, {
                    headers: {
